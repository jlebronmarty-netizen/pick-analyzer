...
create table if not exists public.pick2_raw_mlb_statcast_pitches (
  ...
  check (bat_score is null or bat_score >= 0),
  check (fld_score is null or fld_score >= 0),
  check (post_home_score is null or post_home_score >= 0),
  check (post_away_score is null or post_away_score >= 0),
  check (post_bat_score is null or post_bat_score >= 0),
  check (post_fld_score is null or post_fld_score >= 0)
);

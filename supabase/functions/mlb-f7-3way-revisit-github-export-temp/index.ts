...
const ALLOWED_REF="refs/heads/research/f7-3way-revisit-20260919";
...
Deno.serve(async(req:Request)=>{
  ...
  const {data,error,count}=await db.from("mlb_f7_3way_revisit_base_v1")
    .select("season,game_pk,game_date,home_f7,away_f7,y_class,payload,outcome_lineage,development_class,research_only",{count:"exact"})
  ...
  return json({
    contract:CONTRACT,researchOnly:true,sourceTable:"public.mlb_f7_3way_revisit_base_v1",

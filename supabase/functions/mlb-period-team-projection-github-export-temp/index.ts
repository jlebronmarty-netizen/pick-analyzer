...
const CONTRACT = "MLB_PERIOD_TEAM_PROJECTION_GITHUB_EXPORT_V1/1.0.0";
const AUDIENCE = "supabase-period-team-projection";
...
async function verifyGithubOidc(req: Request) {
  ...
  if (!ref.startsWith("refs/heads/research/period-team-projection-catboost-v1-20260921")) {

...
| **Batter Runs Scored** | `batter_runs_under_0p5_proj_0p14_v1` — UNDER 0.5 when projection <=0.14 | Official Retrosheet player-game 2025; exact 2026 MLB Official game-log reconciliation after prior proxy read | 2025: **1,606/2,075 = 77.40%**; worst month **75.07%**; baseline 73.45%; coverage 3.55% | MLB Official 2026: **779/1,036 = 75.19%**; worst month **70.23%**; baseline 64.51%; coverage 4.03% | 2025 n=2,075; 2026 exact n=1,036 | **POOLED YES; stability NO** | `POOLED_75_PLUS_STABILITY_FLOOR_NOT_MET` | Preserve frozen rule but do not promote; exact 2026 pooled target clears 75% while month stability fails. Requires new untouched forward evidence. |
| **Batter RBIs** | `batter_rbi_under_0p5_proj_0p10_v1` — UNDER 0.5 when projection <=0.10 | Official Retrosheet player-game 2025; exact 2026 MLB Official game-log reconciliation after prior proxy read | 2025: **2,053/2,402 = 85.47%**; worst month **82.26%**; baseline 79.14%; coverage 4.11% | MLB Official 2026: **1,133/1,367 = 82.88%**; worst month **79.26%**; baseline 72.55%; coverage 5.31% | 2025 n=2,402; 2026 exact n=1,367 | **YES** | `TARGET_MET_75_PLUS_EXACT_OUTCOME_RECONCILIATION_LINE_CAPTURE_PENDING` | Preserve frozen rule. Outcome side is now exact; next gate is real sportsbook U0.5 line capture via BALLDONTLIE GOAT / forward evidence. |
| **Batter Hits + Runs + RBIs** | `batter_hrrbi_under_2p5_proj_0p70_v1` — UNDER 2.5 when projection <=0.70 | Official Retrosheet player-game 2025; exact 2026 MLB Official game-log reconciliation after prior proxy read | 2025: **2,278/2,582 = 88.23%**; worst month **85.24%**; baseline 79.62%; coverage 4.42% | MLB Official 2026: **1,073/1,255 = 85.50%**; worst month **82.64%**; baseline 73.20%; coverage 4.88% | 2025 n=2,582; 2026 exact n=1,255 | **YES** | `TARGET_MET_75_PLUS_EXACT_OUTCOME_RECONCILIATION_LINE_CAPTURE_PENDING` | Preserve frozen rule. Outcome side is exact; require real sportsbook U2.5 quote and strict pregame lineage before prospective use. |

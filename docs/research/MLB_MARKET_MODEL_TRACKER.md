...
- Pitcher Walks U2.5;
- Pitcher Strikeouts U6.5 (`pitcher_k_under_6p5_proj_4p5_v1`);
- Batter RBIs U0.5 (`batter_rbi_under_0p5_proj_0p10_v1`);
- Batter Hits + Runs + RBIs U2.5 (`batter_hrrbi_under_2p5_proj_0p70_v1`);
- Pitcher ER O1.5;
...
| **Batter RBIs** | `batter_rbi_under_0p5_proj_0p10_v1` — UNDER 0.5 when projection <=0.10 | Official Retrosheet 2025; exact MLB Official gameLog runtime | 2025: **2,053/2,402 = 85.47%**; worst month **82.26%**; baseline 79.14%; coverage 4.11% | MLB Official 2026: **1,133/1,367 = 82.88%**; worst month **79.26%**; baseline 72.55%; coverage 5.31% | 2025 n=2,402; 2026 exact n=1,367 | **YES** | `DEPLOYED_PENDING_FIRST_PROSPECTIVE_EXACT_LINE_CAPTURE` | Exact-line U0.5 current capture/evaluator wired research-only; first future pregame crossing remains required. |
| **Batter Hits + Runs + RBIs** | `batter_hrrbi_under_2p5_proj_0p70_v1` — UNDER 2.5 when projection <=0.70 | Official Retrosheet 2025; exact MLB Official gameLog runtime | 2025: **2,278/2,582 = 88.23%**; worst month **85.24%**; baseline 79.62%; coverage 4.42% | MLB Official 2026: **1,073/1,255 = 85.50%**; worst month **82.64%**; baseline 73.20%; coverage 4.88% | 2025 n=2,582; 2026 exact n=1,255 | **YES** | `DEPLOYED_PENDING_FIRST_PROSPECTIVE_EXACT_LINE_CAPTURE` | Exact-line U2.5 current capture/evaluator wired research-only; first future pregame crossing remains required. |

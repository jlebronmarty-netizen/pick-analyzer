...
| **Pitcher Strikeouts** | `pitcher_k_under_6p5_proj_4p5_v1` — UNDER 6.5 when leakage-safe projection <=4.5 | `UNIFIED_2025_ROLLING_TO_2026_SINGLE_READ`; separate from preserved `PE_PITCHER_K_V2_INPUT_CONTRACT/2.0.0` | 2025: **1,189/1,367 = 86.98%**; worst month **81.06%**; eligible baseline 75.24%; coverage 40.16% | 2026 single read after committed freeze: **1,035/1,163 = 88.99%**; worst month **76.32%**; eligible baseline 74.73%; coverage 36.20% | 2025 n=1,367; 2026 n=1,163 | **YES** | `TARGET_MET_75_PLUS_EXTERNAL_PASS_MARKET_LINE_CAPTURE_PENDING` | Preserve formula. Add prospective real sportsbook U6.5 capture/parity under a separate gate; no alternate-line extrapolation and no retune from 2026. |
...
| **Pitcher Outs** | Legacy `pitcher_outs_under_18p5_p90_v1` remains blocked; new research `pitcher_outs_under_18p5_blend_15p75_v2` | Legacy runtime parity unresolved; V2 is new xyear research requiring untouched forward validation | V2 2025: **1,245/1,398 = 89.06%**; worst month **83.72%**; baseline 80.96%; coverage 41.07% | 2026 V2 diagnostic only: **1,262/1,423 = 88.69%**; worst month **84.31%**; baseline 81.36%; coverage 44.29% | V2 n=1,398 dev; n=1,423 diagnostic | **YES research; NO clean external/runtime certification** | `TARGET_MET_75_PLUS_RESEARCH_FORWARD_VALIDATION_REQUIRED`; legacy remains `RUNTIME_PARITY_NOT_CERTIFIED` | Do not revive/retune legacy ID. Freeze V2 and validate only on future untouched games with a real U18.5 quote before any runtime promotion. |
...
| **Pitcher Record a Win** | `pitcher_win_forward_numeric_p015_v1` — NO when frozen deployable ensemble p(win) <=0.15 | `PRE_FORWARD_DEPLOYABILITY_FREEZE` / exact numeric parity | Rolling OOF: **128/147 = 87.07%**; worst selected month **75.00%**; unconditional NO baseline 70.92% | Forward runtime deployed from 2026-09-20; real sportsbook NO quote required; prospective outcomes cannot retune | Coverage **1.75%**, n=147 rolling OOF | **YES** | `TARGET_MET_75_PLUS_FORWARD_COMPAT_FREEZE_READY` | Continue prospective freeze/settlement. Keep historical broader champion separate; require real NO quote, exact identity and pregame lineage. |
...
| **Batter Runs Scored** | `batter_runs_under_0p5_proj_0p14_v1` — UNDER 0.5 when projection <=0.14 | Official Retrosheet player-game 2025; SportsDataIO 2026 proxy diagnostic | 2025: **1,606/2,075 = 77.40%**; worst month **75.07%**; baseline 73.45%; coverage 3.55% | 2026 proxy diagnostic: **818/1,085 = 75.39%** but worst month **71.01%**; exact PA/identity external still pending | 2025 n=2,075; 2026 proxy n=1,085 | **YES development; mixed proxy diagnostic** | `DEVELOPMENT_75_PLUS_PROXY_DIAGNOSTIC_MIXED` | Preserve frozen rule; do not promote. Exact external or untouched forward validation required. |
| **Batter RBIs** | `batter_rbi_under_0p5_proj_0p10_v1` — UNDER 0.5 when projection <=0.10 | Official Retrosheet player-game 2025; SportsDataIO 2026 proxy diagnostic | 2025: **2,053/2,402 = 85.47%**; worst month **82.26%**; baseline 79.14%; coverage 4.11% | 2026 proxy diagnostic: **1,130/1,362 = 82.97%**; worst month **79.33%**; exact external pending | 2025 n=2,402; 2026 proxy n=1,362 | **YES** | `TARGET_MET_75_PLUS_PROXY_DIAGNOSTIC_EXACT_EXTERNAL_PENDING` | Preserve frozen rule; exact PA/identity lineage or untouched forward validation required before runtime certification. |
| **Batter Hits + Runs + RBIs** | `batter_hrrbi_under_2p5_proj_0p70_v1` — UNDER 2.5 when projection <=0.70 | Official Retrosheet player-game 2025; SportsDataIO 2026 proxy diagnostic | 2025: **2,278/2,582 = 88.23%**; worst month **85.24%**; baseline 79.62%; coverage 4.42% | 2026 proxy diagnostic: **1,110/1,303 = 85.19%**; worst month **81.65%**; exact external pending | 2025 n=2,582; 2026 proxy n=1,303 | **YES** | `TARGET_MET_75_PLUS_PROXY_DIAGNOSTIC_EXACT_EXTERNAL_PENDING` | Preserve frozen rule; require exact PA/identity and real U2.5 quote before any prospective recommendation. |
| **Batter Stolen Bases** | Official Retrosheet player-game `b_sb` outcome now available; no promoted signal | Official 2025 player-game outcome contract recovered | Simple U0.5 filters reach ~97% but eligible unconditional U0.5 baseline is **95.27%** | No clean external candidate frozen | large 2025 player-game universe | **HIGH RAW ACCURACY, LOW INCREMENTAL SIGNAL** | `TARGET_HIGH_ACCURACY_LOW_INCREMENTAL_SIGNAL` | Keep as baseline-dominated research reference; search only if a materially higher-lift architecture appears. |

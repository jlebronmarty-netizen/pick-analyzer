...
MC-08G Product Polish And Coherence Review update on 2026-08-04: MC-08G is in local certification as a bounded product-polish package after MC-08F. It clarifies user-facing copy and navigation across Homepage, Settings, Most Likely, Best Value, Betting Workbench and Performance loading states while preserving prediction, recommendation, settlement, learning, scheduler, provider, Replay and Current Era behavior. MC-08H and MC-03 were not started.

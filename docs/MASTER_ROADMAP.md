MLB Research F5 Spread transfer closeout (2026-09-22 UTC): 2/2 wins, 0 losses/pushes, 100% descriptive ATS, coverage 2/22 (9.09%). INSUFFICIENT_SAMPLE_NO_PROMOTION; source architecture and 0.75 threshold unchanged. Attempt 2 of run 35675057422 succeeded; exporter v5 verified HTTP 410. Zero Odds API credits; tracker unchanged. See docs/research/MLB_F5_SPREAD_TRANSFER_DIAGNOSTIC_V1_CLOSEOUT.md. Earlier entries below are historical.

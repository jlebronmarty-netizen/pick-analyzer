...
MC-08B Rent Play Experience update on 2026-08-02: MC-08B is locally validated pending production certification. Rent Play now uses the typed `rent_play_v1` presentation contract with explicit probability, odds, freshness, actionability, Official Pick distinction, Most Likely distinction, readiness gates, risks and what-would-change evidence while preserving all prediction, settlement, learning, scheduler, provider and policy guardrails. MC-08C was not started.

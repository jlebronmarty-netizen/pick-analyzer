...
- The default dashboard now starts from Today, Model Lab, Data & Operations and Advanced groups. Advanced provider contracts, NBA readiness and inactive sport modules remain available but are collapsed by default so Day 1 operators start from the MLB workflow.

...
check('stale non-positive edge code filtered when current edge positive', source.includes("code === 'NON_POSITIVE_EDGE'") && source.includes('evidence.edge !== null && evidence.edge > 0'))
check('stale non-positive EV code filtered when current EV positive', source.includes("code === 'NON_POSITIVE_EV'") && source.includes('evidence.ev !== null && evidence.ev > 0'))

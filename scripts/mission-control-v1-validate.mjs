...
check('current mission is MC-00 or later Mission Control mission', ['MC-00', 'MC-01'].includes(status.currentMission?.id))
check('next mission is deterministic', ['MC-01', 'MC-02'].includes(status.nextMission?.id))

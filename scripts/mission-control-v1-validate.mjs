...
check('current mission is MC-00 or later Mission Control mission', ['MC-00', 'MC-01', 'MC-02', 'MC-08H', 'OR-01H', 'OR-02', 'OR-02A'].includes(status.currentMission?.id))

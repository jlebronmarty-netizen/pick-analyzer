...
check('r1f active guard advanced', script.includes("const r1fCertifiedProductionCommit = '2560a3c9c6c147f3aaf7b83c8811648663c9cc1b'"))
check('r1f execute guard pinned', /if \(execute \|\| validateExecuteGuard\) return commit === r1fCertifiedProductionCommit/.test(script))

...
check('r1f digest-bound authority active', script.includes("activeWriteAuthority: 'DIGEST_BOUND_DEPLOYMENT_CERTIFICATION_MANIFEST'"))
check('r1f expected manifest digest env gate', script.includes("const expectedManifestDigestEnvName = 'PICK2_MLB_R1F_EXPECTED_MANIFEST_SHA256'"))
check('r1f explicit dml authorization gate', script.includes("ensure(explicitDmlAuthorization, 'EXPLICIT_DML_AUTHORIZATION_REQUIRED')"))

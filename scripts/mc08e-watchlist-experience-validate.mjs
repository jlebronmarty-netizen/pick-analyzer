...
check('MC-08F forward compatibility is explicit', (status.mc08e?.mc08fStarted === false && cert.safety.mc08fStarted === false && doc.includes('MC-08F was not started')) || status.mc08f?.status === 'LOCAL_VALIDATION_PENDING' || status.mc08f?.status === 'PRODUCTION_CERTIFIED')

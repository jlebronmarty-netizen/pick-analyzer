...
check('alternate lines not collapsed incorrectly by contract', service.includes('marketLineIdentityKey') && service.includes('bookmakerKey') && service.includes('normalizedLine.toFixed'))
check('exact market identity includes normalized line', service.includes('sameMarketLine(prediction.market, row.line, prediction.line)'))

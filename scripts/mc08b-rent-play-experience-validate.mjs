...
check('MC-08 is the selected parent mission', status.nextMission?.id === 'MC-08' && queue.includes('| MC-08 | Daily Betting Product Completion'))
...
check('empty/waiting/candidate states are supported', home.includes('No Rent Play Today') && home.includes('Waiting for fresh price') && home.includes('Best Available Candidate - Not Rent Play'))
...
check('homepage hierarchy remains intact', home.indexOf('data-mc08a-morning-brief="true"') < home.indexOf('data-mc08b-rent-play-card="true"') && home.indexOf('data-mc08b-rent-play-card="true"') < home.indexOf('title="Moneyline Bet"') && home.indexOf('data-mc08a-smart-parlay="true"') < home.indexOf('data-mc08a-watchlist="true"'))

...
CATEGORICAL=["own_team","opp_team","day_night","venue"]
...
def fetch_schedule_decisions(game_pks:set[int])->dict[int,dict[str,Any]]:
    ...
    DECISIONS.write_text(json.dumps({
      "contract":"MLB_PITCHER_WIN_FORWARD_COMPAT_2026_DECISIONS/1.0.0",
...
def main():
    ...
    result={
      ...
      "feature_contract":"DEPLOYABLE_EXACT_PARITY_CORE_V1",
    ...
    freeze={
      "contract":"MLB_PITCHER_WIN_FORWARD_COMPAT_V1_FROZEN_CANDIDATE/1.0.0",
      "protocol":PROTOCOL,"research_only":True,

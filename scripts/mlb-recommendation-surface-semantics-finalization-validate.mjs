...
assert(component.includes('Best Review-Only Candidate - Not Rent Play'), 'review-only Rent Play candidate must be explicitly non-recommendation')
assert(component.includes('No Qualified Moneyline Bet'), 'blocked Moneyline cannot render as qualified primary')
assert(component.includes('Best Review-Only Moneyline Candidate'), 'review-only Moneyline candidate must be explicit')

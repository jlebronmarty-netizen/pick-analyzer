...
assert(service.includes("const WRITE_SCHEDULER_CRON = '*/10 * * * *'"), 'service must define 10-minute write scheduler')
assert(service.includes("const HEARTBEAT_CRON = '3,33 * * * *'"), 'service must define heartbeat cron')

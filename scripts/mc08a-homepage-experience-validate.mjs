...
check('Rent Play remains and is largest/full-width before Moneyline', home.indexOf('data-mc08b-rent-play-card="true"') < home.indexOf('title="Moneyline Bet"') && home.includes('No Rent Play Today'))

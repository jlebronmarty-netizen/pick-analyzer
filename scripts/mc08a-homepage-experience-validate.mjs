...
check('Rent Play remains and is largest/full-width before Moneyline', home.indexOf('<RentPlayCard rentPlay={rentPlayContract} />') < home.indexOf('<MoneylineBetCard moneyline={moneylineBetContract} />') && home.includes('No Rent Play Today'))

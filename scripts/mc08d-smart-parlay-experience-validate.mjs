...
check('no historical leakage path is introduced', !/history|historical|settled/i.test(home.match(/function buildSmartParlayContract[\s\S]*?function MetricBar/)?.[0] ?? ''))

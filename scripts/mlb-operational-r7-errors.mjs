...
for(const code of ['NO_ELIGIBLE_PREGAME_SCOPE','OPERATIONAL_BUDGET_CLOCK','OPERATIONAL_RESERVATION_IDENTITY','OPERATIONAL_ODDS_STAGE','ODDS_CREDIT_SHAPE','ODDS_CREDIT_CONFLICT','OPERATIONAL_RESERVATION_MISSING','OPERATIONAL_BUDGET_SCHEMA'])codes.add(code)

          ...
          <Panel title="Provider Health" status={provider.healthy ? 'healthy' : 'limited'}>
            <Rows
              items={[
                ...
                ['Protected Reserve', provider.reserve],
                ['Usable Remaining', provider.usableRemaining],
                ['Evidence Level', provider.evidenceLevel],
                ['Unit Type', provider.unitType],
                ['Reset Semantics', provider.resetSemantics],
                ['Next Action Authorized', provider.nextActionAuthorized ? 'yes' : 'no', provider.nextActionAuthorized ? 'ready' : 'waiting'],
          ...
          <Panel title="Provider Budget" status={budget.remaining > 0 ? 'healthy' : 'blocked'}>
            <Rows
              items={[
                ...
                ['Usable Remaining', budget.usableRemaining],
                ['Evidence Level', budget.evidenceLevel],
                ['Unit Type', budget.unitType],
                ['Reset Semantics', budget.resetSemantics],
                ['Next Action Authorized', budget.nextActionAuthorized ? 'yes' : 'no', budget.nextActionAuthorized ? 'ready' : 'waiting'],

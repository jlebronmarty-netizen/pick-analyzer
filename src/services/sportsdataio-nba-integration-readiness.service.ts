...
function externalApprovalPacket({
  ...
  return {
    ...
    prohibitedActions: [
      ...
      'Do not persist player stats until the additive sport_player_stats migration is applied and verified.',
...
export function getSportsDataIoNbaIntegrationReadiness() {
  ...
  const closedGuardrailEvidenceItems = [
    ...
    'no_player_stats_before_migration',
    ...
    readinessEvidenceItem({
      ...
      title: [
        ...
        'Odds, historical odds, player stats and player props require confirmed endpoints before live calls.',
        'Player-stat persistence requires the additive sport_player_stats migration.',
  ...
  return {
    ...
    completionScope: {
      ...
      persistence: 'trial_persistence_verified_for_events_stats_players_injuries_lineups; player_stats_migration_pending',
    ...
    handoff: {
      ...
      productionGates: [
        ...
        'Do not run odds, historical odds, player stats or player props pilots until exact endpoints and entitlements are confirmed.',
        'Do not persist player stats until supabase/migrations/202607130002_sport_player_stats_v1.sql is applied.',
        'Do not enable player prop settlement until market and grading rules are implemented and validated.',
      ],
      safeNextActions: [
        'Apply the additive sport_player_stats migration only when player-stat persistence is approved.',
        'Confirm exact SportsDataIO NBA odds, historical odds, player-stat and prop endpoint paths from authenticated provider documentation before live calls.',

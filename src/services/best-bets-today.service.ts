...
export function validateBestBetsTodayFixtures() {
  ...
  const base = {
    ...
    oddsAgeMinutes: 20,
    marketInputTimestamp: '2026-07-17T18:00:00.000Z',
    marketInputAgeMinutes: 20,
    marketFreshnessTimestamp: '2026-07-17T18:00:00.000Z',
    marketFreshnessSource: 'snapshot_ingested_at' as const,
    marketSourceTimestamp: '2026-07-17T18:00:00.000Z',
    marketSourceAgeMinutes: 20,
    providerSourceUpdatedAt: '2026-07-17T18:00:00.000Z',
    ...
    marketAlignment: buildMarketAlignment({
      ...
      marketInputTimestamp: '2026-07-17T18:00:00.000Z',
      providerSourceTimestamp: '2026-07-17T18:00:00.000Z',
      oddsIngestedAt: '2026-07-17T18:00:00.000Z',
      marketAgeMinutes: 20,
      providerSourceAgeMinutes: 20,
      snapshotIngestionAgeMinutes: 20,
  ...
  const board = {
    ...
    oldestVisibleMarketSnapshotTimestamp: base.marketFreshnessTimestamp,
    dataFreshness: {
      status: 'fresh',
      latestOddsTimestamp: base.oddsTimestamp,
      ...
      latestSourceTimestamp: base.marketSourceTimestamp,
      latestVisibleMarketSnapshotTimestamp: base.marketFreshnessTimestamp,
      oldestVisibleMarketSnapshotTimestamp: base.marketFreshnessTimestamp,
      visibleMarketCount: 1,
      freshVisibleMarketCount: 1,

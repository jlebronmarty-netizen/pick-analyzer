...
const CAPABILITIES: MarketCapability[] = [
  ...
  },
  {
    ...
    priceRequired: true,
    supportedSportsbooks: [],
    settlementRule: 'Deterministic shadow settlement requires score after exactly five completed innings.',
    ...
    currentStatus: 'unavailable_from_provider',
    userVisible: false,
    evidence: 'Provider-independent readiness and settlement contracts exist; no verified stored first-five MLB odds are currently normalized and listed-starter rules are not approved.',
  },
  {

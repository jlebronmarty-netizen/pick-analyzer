...
const DEFINITIONS: FeatureDefinition[] = [
  {
    ...
    version: '1.0.0',
    sportKeys: ['basketball_nba', 'basketball_bsn', 'baseball_mlb', 'americanfootball_nfl', 'icehockey_nhl', 'soccer', 'tennis', 'mma_ufc'],
  ...
  },
  {
    ...
    version: '1.0.0',
    sportKeys: ['basketball_nba', 'basketball_bsn', 'baseball_mlb', 'americanfootball_nfl', 'icehockey_nhl', 'soccer'],
    markets: ['moneyline', 'spread', 'total'],
    valueType: 'json',
  ...
  },
  {
    ...
    version: '1.0.0',
    sportKeys: ['basketball_nba', 'basketball_bsn', 'americanfootball_nfl', 'baseball_mlb', 'icehockey_nhl'],
    markets: ['moneyline', 'spread', 'total'],
    valueType: 'json',
    maxAgeMinutes: 24 * 60,
    required: false,
  ...
  {
    key: 'basketball_team_intelligence',
    displayName: 'Basketball Team Intelligence',
    version: '1.0.0',
    sportKeys: ['basketball_nba', 'basketball_bsn'],
    markets: ['moneyline', 'spread', 'total', 'first_half'],
    valueType: 'json',
    maxAgeMinutes: 12 * 60,
    required: false,
    sourceTables: ['sport_events', 'sport_game_stats', 'sport_standings'],
    description: 'Reusable basketball ratings for home court, travel, rest, momentum, opponent strength, recent form and splits.',
    noLeakageRule: 'Basketball team intelligence must use only games and standings observed before cutoff_at.',
  },
  {
    key: 'basketball_period_context',
    displayName: 'Basketball Period Context',
    version: '1.0.0',
    sportKeys: ['basketball_nba', 'basketball_bsn'],
    markets: ['first_half', 'first_quarter', 'total', 'spread'],
    valueType: 'json',
    maxAgeMinutes: 12 * 60,
    required: false,
    sourceTables: ['sport_events', 'sport_game_stats'],
    description: 'First-half, quarter scoring, fourth-quarter, overtime and close-game context when period scores are available.',
    noLeakageRule: 'Period context must be generated from completed historical games only and never from the target game.',
  },
  {
    key: 'basketball_playoff_context',
    displayName: 'Basketball Playoff Context',
    version: '1.0.0',
    sportKeys: ['basketball_nba', 'basketball_bsn'],
    markets: ['moneyline', 'spread', 'total', 'first_half'],
    valueType: 'json',
    maxAgeMinutes: 12 * 60,
    required: false,
    sourceTables: ['sport_events', 'sport_standings'],
    description: 'Playoff pressure, elimination pressure, qualification pressure, series pressure and series momentum.',
    noLeakageRule: 'Playoff context must be based on known pregame standings, stage and series metadata.',
  },
  {
    key: 'starter_status_context',
    displayName: 'Starter Status Context',
    version: '1.0.0',
    ...
    maxAgeMinutes: 6 * 60,
    required: false,
    sourceTables: ['sports_sync_jobs'],
    description: 'Verified GamesByDate probable/starting pitcher IDs, names, opener flags and starter confidence.',
    noLeakageRule: 'Starter status must come from a pregame GamesByDate verification snapshot captured before event start.',
  },
  {
    key: 'pitcher_context',
    displayName: 'Pitcher Context',
    version: '1.0.0',
    sportKeys: ['baseball_mlb'],
    markets: ['moneyline', 'spread', 'total'],
    valueType: 'json',
    maxAgeMinutes: 24 * 60,
    required: false,
    sourceTables: ['sports_sync_jobs', 'sport_players', 'sport_player_stats'],
    description: 'Starter quality, reliability, volatility, freshness and mapped pitcher metadata when available.',
    noLeakageRule: 'Pitcher features must be generated from pregame starter identity plus player/stat rows observed before cutoff.',
  },
  {
    key: 'weather_context',
    displayName: 'Weather Context',
    version: '1.0.0',
    sportKeys: ['baseball_mlb'],
    markets: ['moneyline', 'spread', 'total'],
    valueType: 'json',
    ...
    required: false,
    sourceTables: ['sports_sync_jobs'],
    description: 'Verified forecast temperatures, description, wind chill, wind speed, wind direction and derived run environment.',
    noLeakageRule: 'Weather features must be captured before event start and before prediction lock.',
  },
  {
    key: 'park_context',
    displayName: 'Park Context',
    version: '1.0.0',
    sportKeys: ['baseball_mlb'],
    markets: ['moneyline', 'spread', 'total'],
    valueType: 'json',
    ...
    required: false,
    sourceTables: ['sports_sync_jobs'],
    description: 'Verified StadiumID and cached stadium metadata-derived park, run, home run, weather and wind factors.',
    noLeakageRule: 'Park metadata is static or pregame context and must not include target-game results.',
  },
]

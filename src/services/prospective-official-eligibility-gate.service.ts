...
function fixtureCandidate(overrides: Partial<CurrentBoardCandidate> = {}): CurrentBoardCandidate {
  ...
  const base: CurrentBoardCandidate = {
    ...
    oddsAgeMinutes: 0,
    marketInputTimestamp: now.toISOString(),
    marketInputAgeMinutes: 0,
    marketFreshnessTimestamp: now.toISOString(),
    marketFreshnessSource: 'snapshot_ingested_at',
    marketSourceTimestamp: now.toISOString(),
    marketSourceAgeMinutes: 0,
    providerSourceUpdatedAt: now.toISOString(),
    ...
    marketAlignment: buildMarketAlignment({
      ...
      marketInputTimestamp: now.toISOString(),
      providerSourceTimestamp: now.toISOString(),
      oddsIngestedAt: now.toISOString(),
      marketAgeMinutes: 0,
      providerSourceAgeMinutes: 0,
      snapshotIngestionAgeMinutes: 0,
      maxAllowedAgeMinutes: 120,
      confidence: 78,
      recommendationCategory: 'PLAY_OF_DAY_CANDIDATE',
    }),
    maxAllowedAgeMinutes: 120,
    ...
    winProbability: 62,
    probability: 62,
    edgePercentagePoints: 16.55,
    expectedValuePercent: 32,
    analysisSnapshotTimestamp: now.toISOString(),
    calibratedProbability: 61,
    confidence: 78,
